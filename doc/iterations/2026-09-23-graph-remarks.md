...
Полоска активной панели не смыкалась с полоской выделенной первой строки: между ними
оставалась нижняя граница шапки, а `box-shadow: inset` её не закрывает. Полоска шапки теперь
— псевдоэлемент, заходящий на эту границу (`Panel.svelte`).
