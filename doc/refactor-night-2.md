...
- [ ] 1.7 FS-1-03, FC-1-02: дифф — показанный файл отдельно от запрошенного; выделение и
  подтверждение Discard сбрасываются со сменой диффа
- [ ] 1.8 FS-1-04: submodules.refresh не затирает раскрытое
- [ ] 1.9 FS-1-05: сетевые операции по отдельности
- [ ] 1.10 FS-1-06: conflicts.take/write не закрывают другой файл
...
- [ ] 1.15 FC-1-01: шаблон коммита A не становится черновиком B

### Категория 2 — баги и несостыковки

- [ ] 2.1 AS-2-01…05: патч выделенных строк (направление, пустая сторона, маркер EOF, EOL,
  /dev/null)
...
- [ ] 2.5 GE-2-05: apply_commit_file не зависит от diff.* пользователя
...
- [ ] 2.11 GE-2-16, GE-2-17: `~` в путях конфига; окружение dry-run хуков
- [ ] 2.12 GE-2-18: повторный finish после конфликта
- [ ] 2.13 GE-2-19, 20, 21, 23, 24, 25, 26: мелкие git_engine
- [ ] 2.14 AS-2-06, AS-2-07, AS-2-08: diff_engine — невалидный UTF-8, ложные картинки, -w
- [ ] 2.15 AS-2-09, AS-2-10: Undo после конфликта, Undo удаления worktree
- [ ] 2.16 AS-2-11, 12, 13, 16, 17: мелкие app_state и avatars
...
- [ ] 2.20 FS-2-01, FS-2-02: циклы эффектов (уведомления, окна Compare/Blame)
- [ ] 2.21 FS-2-03…09: мелкие сторы и lib
- [ ] 2.22 FA-2-01: merge/rebase из перетаскивания — над названной веткой
- [ ] 2.23 FA-2-02…19, 24: App и окна
- [ ] 2.24 FC-2-01…16: компоненты
- [ ] 2.25 Документы: ST-2-15, AS-2-22

### Категория 3 — неиспользуемое

- [ ] 3.1 Rust: GE-3-01…03, AS-3-01, 03, 04, 05, ST-3-01
- [ ] 3.2 Фронт: FS-3-01, FS-3-02, FC-3-01, FC-3-02, FA-3-01…06

### Категория 4 — дубли

- [ ] 4.1 Rust: GE-4-01…03, AS-4-01, AS-4-02, ST-4-01, ST-4-02
- [ ] 4.2 Фронт: FS-4-01…04, FA-4-01…06, FC-4-02
