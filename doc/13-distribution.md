...
api-ms-win-crt-heap-l1-1-0  api-ms-win-crt-locale-l1-1-0  api-ms-win-crt-math-l1-1-0
api-ms-win-crt-runtime-l1-1-0  api-ms-win-crt-stdio-l1-1-0  api-ms-win-crt-string-l1-1-0
bcrypt  bcryptprimitives  comctl32  crypt32  dwmapi  gdi32  kernel32  ntdll  ole32
oleaut32  shell32  shlwapi  user32  userenv  ws2_32
```

По сравнению с замером 19 сентября добавились `bcrypt`, `crypt32`, `userenv` и `ws2_32` —
