...
2. Бэкенд обходит историю отмеченных ссылок и шлёт чанки по 200 коммитов; каждый чанк
   уже содержит готовую раскладку своих строк — узел и все сегменты строки
   ([07-graph-rendering.md §2](07-graph-rendering.md#2-модель-данных)).
...
pub struct GraphChunk {
    ...
    pub rows: Vec<GraphRow>,   // по одной на коммит, в том же порядке
    pub is_last: bool,
}
```
