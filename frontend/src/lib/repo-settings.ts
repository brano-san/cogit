...
export const FIELDS: readonly SettingField[] = [
  ...
  { key: "user.email", tab: "user", label: "Email", control: { kind: "text" }, fallback: "" },
  {
    ...
    fallback: "false",
    hint: "How git pull joins diverged branches. Cogit's own Pull follows Preferences ▸ Pull instead.",
  },
  {
    key: "fetch.prune",
    tab: "fetch",
  ...
  },
  {
    ...
    control: BOOL,
    fallback: "false",
    hint: "Pull and checkout also move initialized submodules to the recorded commit.",
  },
  {
